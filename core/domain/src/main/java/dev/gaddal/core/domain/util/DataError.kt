...
sealed interface DataError : Error {
    ...
    enum class Local : DataError {
        ...
        UNAUTHENTICATED, // Unauthenticated access due to invalid credentials.
        ...
        ALREADY_EXISTS, // The resource already exists and cannot be created.
        INVALID_PIN, // The PIN code provided is invalid.
